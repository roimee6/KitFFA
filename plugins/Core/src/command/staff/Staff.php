...
class Staff extends BaseCommand
{
    ...
    private function sendItems(Player $player): void
    {
        ...
        $player->getInventory()->setItem(0, ItemFactory::getInstance()->get(507)->setCustomName("§r" . Util::PREFIX . "Spectateur §9§l«"));
        $player->getInventory()->setItem(2, ItemFactory::getInstance()->get(341)->setCustomName("§r" . Util::PREFIX . "Knockback 2 §9§l«")->addEnchantment($knockback));
        $player->getInventory()->setItem(3, ItemFactory::getInstance()->get(339)->setCustomName("§r" . Util::PREFIX . "Alias §9§l«"));
        $player->getInventory()->setItem(4, ItemFactory::getInstance()->get(381)->setCustomName("§r" . Util::PREFIX . "Random Tp §9§l«"));
        $player->getInventory()->setItem(5, ItemFactory::getInstance()->get(369)->setCustomName("§r" . Util::PREFIX . "Freeze §9§l«"));
        $player->getInventory()->setItem(6, ItemFactory::getInstance()->get(280)->setCustomName("§r" . Util::PREFIX . "Sanction §9§l«"));
        $player->getInventory()->setItem(7, ItemFactory::getInstance()->get(54)->setCustomName("§r" . Util::PREFIX . "Invsee §9§l«"));
        $player->getInventory()->setItem(8, ItemFactory::getInstance()->get(130)->setCustomName("§r" . Util::PREFIX . "Ecsee §9§l«"));

        if (in_array($player->getName(), Vanish::$vanish)) {
            $player->getInventory()->setItem(1, ItemFactory::getInstance()->get(351, 10)->setCustomName("§r" . Util::PREFIX . "Vanish §9§l«"));
        } else {
            $player->getInventory()->setItem(1, ItemFactory::getInstance()->get(351, 8)->setCustomName("§r" . Util::PREFIX . "Vanish §9§l«"));
        }
    }
