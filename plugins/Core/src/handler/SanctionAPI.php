...
class SanctionAPI
{
    ...
    {
        $targetPlayer = Util::getPlayer($target);
        ...
        Base::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Le joueur §9" . $target . " §fa été banni pendant §9" . $format . "§f par §9" . $player . "§f, raison: §9" . $sanction);
    ...
    private static function kickPlayer(Player $player, string $target, string $sanction): void
    {
        ...
        Base::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Le joueur §9" . $targetPlayer->getName() . " §fa été expulsé du serveur par §9" . $player->getName() . "§f, raison: §9" . $sanction);
    ...
    private static function mutePlayer(Player $player, string $target, string $sanction, int $time): void
    {
        ...
        Base::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Le joueur §9" . $targetPlayer->getName() . " §fa été mute pendant §9" . $format . " §fpar §9" . $player->getName() . "§f, raison: §9" . $sanction);
